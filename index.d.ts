...
export class BeforeChatEventSignal {
  subscribe(callback: () => BeforeChatEvent): void;
...
export class BeforeDataDrivenEntityTriggerEventSignal {
  subscribe(callback: () => BeforeDataDrivenEntityTriggerEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class Block {
  ...
  getTags(): void;
  hasTag(tag): void;
  setPermutation(permutationPermutation): void;
  setType(blockTypeType): void;
};
export class BlockAreaSize {
  x;
  y;
  z;
  constructor(x, y, z): void;
  equals(otherAreaSize): void;
};
...
export class BlockType {
  canBeWaterlogged;
  id;
  createDefaultBlockPermutation(): void;
};
export class BlockWaterContainerComponent {
  customColor;
  fillLevel;
  location;
  addDye(itemType): void;
};
...
export class Color {
  ...
  green;
  red;
  constructor(red, green, blue, alpha): void;
};
...
export class DefinitionModifier {
  ...
  triggers;
  constructor(componentGroupsToAdd, componentGroupsToRemove, triggers): void;;
};
export class Dimension {
  createExplosion(location, radius, explosionOptions): void;
  getBlock(location): void;
  getBlockFromRay(location, direction, options): void;
  getEntities(getEntities): void;
  getEntitiesAtBlockLocation(location): void;
  getEntitiesFromRay(location, direction, options): void;
  getPlayers(getPlayers): void;
  isEmpty(location): void;
  runCommand(commandString): void;
  spawnEntity(identifier, location): void;
};
export class Effect {
  amplifier;
  displayName;
...
export class Enchantment {
  level;
  type;
  constructor(type, level): void;
};
export class EnchantmentList {
  slot;
  constructor(slot): void;
  addEnchantment (): void;
  canAddEnchantment (): void;
  getEnchantment (): void;
  hasEnchantment (): void;
  next(): void;
...
export class Entity {
  ...
  velocity;
  viewVector;
  addEffect(effectTypeType, duration, amplifier): void;
  addTag(tag): void;
  getBlockFromViewVector(options): void;
  getComponent(componentId): void;
  getComponents(): void;
  getEffect(effectTypeType): void;
  getEntitiesFromViewVector(options): void;
  getTags(): void;
  hasComponent(componentId): void;
  hasTag(tag): void;
  kill(): void;
  removeTag(tag): void;
  runCommand(commandString): void;
  setVelocity(velocity): void;
  teleport(location, dimension, xRotation, yRotation): void;
  teleportFacing(location, dimension, facingLocation): void;
...
export class Events {
  ...
  beforeItemUse: BeforeItemUseOnEventSignal;
  beforeItemUseOn: BeforeItemUseOnEventSignal;
  beforePistonActivate: beforePistonActivate;
...
export class ExplosionEventSignal {
  subscribe(callback: () => ExplosionEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class ItemDefinitionEventSignal {
  subscribe(callback: () => ItemDefinitionTriggeredEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class ItemDurabilityComponent {
  ...
  id;
  maxDurability;
  getDamageChance(unbreaking): void;
};
...
export class ItemStack {
  ...
  id;
  nameTag;
  constructor(itemType, amount, data): void;
  getComponent(componentId): void;
  getComponents(): void;
  getLore(): void;
  hasComponent(componentId): void;
...
export class ItemUseEventSignal {
  subscribe(callback: () => ItemUseEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class ItemUseOnEventSignal {
  subscribe(callback: () => ItemUseOnEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class MinecraftBlockTypes {
  ...
  static get(typeName): void;
  static getAllBlockTypes(): void;
};
...
export class PistonActivateEventSignal {
  subscribe(callback: () => PistonActivateEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class Player {
  ...
  getEffect(effectTypeType): void;
  getEntitiesFromViewVector(options): void;
  getItemCooldown(itemCategory): void;
  getTags(): void;
  hasComponent(componentId): void;
  hasTag(tag: string): void;
  kill(): void;
  removeTag(tag: string): void;
  runCommand(commandString: string): void;
  setVelocity(velocity): void;
  startItemCooldown(itemCategory, tickDuration): void;
  teleport(location: Location, dimension: Dimension, xRotation, yRotation): void;
  teleportFacing(location: Location, dimension: Dimension, facingLocation): void;
  triggerEvent(eventName): void;
};
export class PlayerInventoryComponentContainer {
  ...
  getItem(slot: number): void;
  setItem(slot: number, itemStack: ItemStack): void;
  swapItems(slot: number, otherSlot: number, otherContainer): void;
  transferItem(fromSlot: number, toSlot: number, toContainer): void;
};
export class PlayerJoinEvent {
  player: Player;
};
export class PlayerJoinEventSignal {
  subscribe(callback: () => PlayerJoinEvent): void;
  unsubscribe(callback: () => void): void;
};
...
export class PlayerLeaveEventSignal {
  subscribe(callback: () => PlayerLeaveEvent): void;
  unsubscribe(callback: () => void): void;
};
export class Seat {
  lockRiderRotation;
...
export class TickEventSignal {
  subscribe(callback: () => TickEvent): void;
  unsubscribe(callback: () => void): void;
};
export class Trigger {
  eventName: string;
  constructor(eventName): void;
};
export class Vector {
  x;
  y;
...
export class WeatherChangeEventSignal {
  subscribe(callback: () => WeatherChangeEvent): void;
  unsubscribe(callback: () => void): void;
};
export class World {
  events: string;
  broadcastClientMessage(): void;
  playSound(soundID, soundOptions): void;
  getDimension(dimensionName): dimension: Dimension;
